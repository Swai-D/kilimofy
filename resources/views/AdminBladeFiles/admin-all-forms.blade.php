...
@section('content-header', 'Forms')
@section('content-parent', 'Form Fiels')
@section('content-details', 'All Forms')
  ...
  <div class="row">
    <div class="col-sm-12 col-xl-6">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <form class="theme-form" action="/kilimofy/Admin/admin-all-forms-post" method="post" enctype="multipart/form-data">
              @csrf
            <div class="card-header">
              <h5>Post for Newfeeds</h5><span>Hapa ndipo utaweza andika post na kushare na watu wote waliojiunga na matandao wa kilimofy.</span>
            </div>
            <div class="card-body">

                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Heading">Kicha cha Post</label>
                  <input class="form-control" name="Heading" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" placeholder="Enter email">
                </div>
                <br>
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Tag1">Tag One</label>
                  <select class="form-select" name="Tag1">
                    <option value="" selected disabled>--chagua--</option>
                    <option value="Kilimo">Kilimo</option>
                    <option value="Ufugaji">Ufugaji</option>
                    <option value="Kilimo Biashara">Kilimo Biashara</option>
                ...
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Tag2">Tag Two</label>
                  <select class="form-select" name="Tag2">
                    <option value="" selected disabled>--chagua--</option>
                    <option value="Kilimo">Kilimo</option>
                    <option value="Ufugaji">Ufugaji</option>
                    <option value="Kilimo Biashara">Kilimo Biashara</option>
                ...
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Tag3">Tag Three</label>
                  <select class="form-select" name="Tag3">
                    <option value="" selected disabled>--chagua--</option>
                    <option value="Kilimo">Kilimo</option>
                    <option value="Ufugaji">Ufugaji</option>
                    <option value="Kilimo Biashara">Kilimo Biashara</option>
                ...
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Tag4">Tag Four</label>
                  <select class="form-select" name="Tag4">
                    <option value="" selected disabled>--chagua--</option>
                    <option value="Kilimo">Kilimo</option>
                    <option value="Ufugaji">Ufugaji</option>
                    <option value="Kilimo Biashara">Kilimo Biashara</option>
                ...
                <br>
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Description">Post Description</label>
                  <textarea class="form-control" rows="8" name="Description" id="exampleInputPassword1" placeholder="Write Here .."></textarea>
                </div>
                <br>
                <div class="mb-3">
                  <label class="col-form-label pt-0" for="Media">Post Image</label>
