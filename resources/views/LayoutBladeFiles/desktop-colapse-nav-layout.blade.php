<nav id="navigation-widget" class="navigation-widget navigation-widget-desktop sidebar left hidden" data-simplebar>
  ...
  <div class="user-short-description">
    ...
    <a class="user-short-description-avatar user-avatar medium" href="/kilimofy/UserAccount/about_user_page">
      <!-- USER AVATAR BORDER -->
    ...
    <p class="user-short-description-text"><a href="#">www.kilimofy/{{Auth::user()->user_name}}.com</a></p>
    <!-- /USER SHORT DESCRIPTION TEXT -->
  </div>
  <!-- /USER SHORT DESCRIPTION -->
