        ...
        <div class="widget-box">
          ...
          <div class="progress-arc-summary">
            ...
            <div class="progress-arc-summary-info">
              ...
              <!-- PROGRESS ARC SUMMARY TITLE -->
              {{--<p class="progress-arc-summary-subtitle">{{$user_location->regionName}}, {{$user_location->countryName}}</p>--}}
              <!-- /PROGRESS ARC SUMMARY TITLE -->
                  ...
                  <a class="user-status-avatar" href="profile-timeline.html">
                    ...
                    <div class="user-avatar small no-outline">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-30-32" data-src="/Uploads/avatars/{{$post->User_Image_Profile}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
          ...
          <div class="widget-box-status">
            ...
            <div class="post-preview medium">
              ...
              <figure class="post-preview-image liquid">
                <img src="/Uploads/PostPhotos/{{$post->Photo}}" alt="cover-19">
              </figure>
              <!-- /POST PREVIEW IMAGE -->
