              ...
              <div class="form-row">
                ...
                <div class="form-item">
                  ...
                  <div class="form-textarea">
                    <textarea id="forum-post-text" name="Post_Content" placeholder="Habari {{Auth::user()->user_name}}! Changia ujumbe wako hapa..."></textarea>
          ...
          <div class="quick-post-footer">
            ...
            <div class="quick-post-footer-actions">
              ...
              <div class="quick-post-footer-action text-tooltip-tft-medium image-upload" data-title="Insert Photo">
                ...
                <input name="Author_Name"  type="hidden" value="{{Auth::user()->user_name}}" />
