            ...
            <div class="form-row">
              ...
              <div class="form-item">
                ...
                <div class="form-input small active">
                  <label for="group-tagline">Mada ya huu Mjadala ?</label>
            ...
            <div class="form-row">
              ...
              <div class="form-item">
                ...
                <div class="form-input small mid-textarea">
                  <textarea id="group-description" name="Discussion_Content" placeholder="Andika maelezo kuhusu madaa unayoianda ..."></textarea>
                </div>
                <!-- /FORM INPUT -->
              </div>
              <!-- /FORM ITEM -->
