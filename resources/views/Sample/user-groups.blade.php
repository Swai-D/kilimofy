...
@section('active-user-groups', 'active')
@section('user-data')
<section class="section">
     ...
     <div class="grid grid-4-4-4 centered">
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/29.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
       ...
       <div class="user-preview">
         <!-- USER PREVIEW COVER -->
         <figure class="user-preview-cover liquid">
           <img src="/assets/img/cover/27.jpg" alt="cover-27">
         </figure>
         <!-- /USER PREVIEW COVER -->
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/25.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
       ...
       <div class="user-preview">
         <!-- USER PREVIEW COVER -->
         <figure class="user-preview-cover liquid">
           <img src="/assets/img/cover/48.jpg" alt="cover-48">
         </figure>
         <!-- /USER PREVIEW COVER -->
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/28.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/27.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
       ...
       <div class="user-preview">
         <!-- USER PREVIEW COVER -->
         <figure class="user-preview-cover liquid">
           <img src="/assets/img/cover/41.jpg" alt="cover-41">
         </figure>
         <!-- /USER PREVIEW COVER -->
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/26.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
       ...
       <div class="user-preview">
         <!-- USER PREVIEW COVER -->
         <figure class="user-preview-cover liquid">
           <img src="/assets/img/cover/46.jpg" alt="cover-46">
         </figure>
         <!-- /USER PREVIEW COVER -->
         ...
         <div class="user-preview-info">
           ...
           <div class="user-short-description">
             ...
             <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.html">
               ...
               <div class="user-avatar-content">
                 <!-- HEXAGON -->
                 <div class="hexagon-image-100-110" data-src="/assets/img/avatar/30.jpg"></div>
                 <!-- /HEXAGON -->
               </div>
               <!-- /USER AVATAR CONTENT -->
             </a>
