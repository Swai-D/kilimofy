...
class ForumController extends Controller
{
    public function forum_categories_page()
    {
      ...
      return view('ForumBladeFiles.forum-categories', compact('forum_category', 'forum_category_last_created'));
    }
    ...
    public function forum_category_topics_page(Forum $forum_id)
    {
      ...
      return view('ForumBladeFiles.forum-category-topics', compact('forum_selected', 'discussions', 'last_discussions_created_at'));
    }
    ...
    public function create_discussion(Request $request)
    {
      ...
      if (isset($data)) {
        ...
        $new_discussion->Discussion_Content = $request->Discussion_Content;
